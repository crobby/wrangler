...
type MutatingWebhookConfigurationController interface {
	generic.ControllerInterface[*v1.MutatingWebhookConfiguration, *v1.MutatingWebhookConfigurationList]
}
...
type MutatingWebhookConfigurationClient interface {
	generic.ClientInterface[*v1.MutatingWebhookConfiguration, *v1.MutatingWebhookConfigurationList]
}
...
type MutatingWebhookConfigurationCache interface {
	generic.CacheInterface[*v1.MutatingWebhookConfiguration]
}
