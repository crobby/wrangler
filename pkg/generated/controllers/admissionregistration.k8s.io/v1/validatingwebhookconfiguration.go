...
type ValidatingWebhookConfigurationController interface {
	generic.ControllerInterface[*v1.ValidatingWebhookConfiguration, *v1.ValidatingWebhookConfigurationList]
}
...
type ValidatingWebhookConfigurationClient interface {
	generic.ClientInterface[*v1.ValidatingWebhookConfiguration, *v1.ValidatingWebhookConfigurationList]
}
...
type ValidatingWebhookConfigurationCache interface {
	generic.CacheInterface[*v1.ValidatingWebhookConfiguration]
}
