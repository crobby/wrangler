...
type CustomResourceDefinitionController interface {
	generic.ControllerInterface[*v1.CustomResourceDefinition, *v1.CustomResourceDefinitionList]
}
...
type CustomResourceDefinitionClient interface {
	generic.ClientInterface[*v1.CustomResourceDefinition, *v1.CustomResourceDefinitionList]
}
...
type CustomResourceDefinitionCache interface {
	generic.CacheInterface[*v1.CustomResourceDefinition]
}
