...
func (v *version) Node() NodeController {
	return generic.NewController[*v1.Node, *v1.NodeList](schema.GroupVersionKind{Group: "", Version: "v1", Kind: "Node"}, "nodes", true, v.controllerFactory)
}

func (v *version) Namespace() NamespaceController {
	return generic.NewController[*v1.Namespace, *v1.NamespaceList](schema.GroupVersionKind{Group: "", Version: "v1", Kind: "Namespace"}, "namespaces", true, v.controllerFactory)
}
...
func (v *version) PersistentVolume() PersistentVolumeController {
	return generic.NewController[*v1.PersistentVolume, *v1.PersistentVolumeList](schema.GroupVersionKind{Group: "", Version: "v1", Kind: "PersistentVolume"}, "persistentvolumes", true, v.controllerFactory)
}
