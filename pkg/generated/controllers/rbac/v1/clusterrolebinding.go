...
type ClusterRoleBindingController interface {
	generic.ControllerInterface[*v1.ClusterRoleBinding, *v1.ClusterRoleBindingList]
}
...
type ClusterRoleBindingClient interface {
	generic.ClientInterface[*v1.ClusterRoleBinding, *v1.ClusterRoleBindingList]
}
...
type ClusterRoleBindingCache interface {
	generic.CacheInterface[*v1.ClusterRoleBinding]
}
