...
func (v *version) ClusterRole() ClusterRoleController {
	return generic.NewController[*v1.ClusterRole, *v1.ClusterRoleList](schema.GroupVersionKind{Group: "rbac.authorization.k8s.io", Version: "v1", Kind: "ClusterRole"}, "clusterroles", true, v.controllerFactory)
}

func (v *version) ClusterRoleBinding() ClusterRoleBindingController {
	return generic.NewController[*v1.ClusterRoleBinding, *v1.ClusterRoleBindingList](schema.GroupVersionKind{Group: "rbac.authorization.k8s.io", Version: "v1", Kind: "ClusterRoleBinding"}, "clusterrolebindings", true, v.controllerFactory)
}
